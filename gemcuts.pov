 ...
 *
 * POV-Ray 3.7 or later 2-pass render instructions:
 *   With POV-Ray 3.7 or later, radiosity save_file/load_file must be specified
 *   on the command line.  Follow these steps to insure a proper render.
 *   Step 1:
...
#default
{ finish
  { ambient rgb (Pass = 0 & Quality = 0? 0.2: 0) * DIFFUSE
    diffuse DIFFUSE
  ...
  #switch (Pass)
    ...
    #case (1)
      ...
      { count 300
        ...
        pretrace_end Pixel
        recursion_limit RECURSION_LIMIT
        // See POV-Ray 3.7 2-pass render instructions:
        #if (version < 3.7) save_file S_RAD_FILENAME #end
      }
      #break
    ...
    #case (2)
      ...
      { always_sample off
        ...
        recursion_limit RECURSION_LIMIT
        // See POV-Ray 3.7 2-pass render instructions:
        #if (version < 3.7) load_file S_RAD_FILENAME #end
      }
      #break
